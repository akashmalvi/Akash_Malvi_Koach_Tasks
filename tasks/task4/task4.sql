...
insert into student_s(std_name,std_code,std_id,status,grp_id)
...
insert into student_s (std_name,std_code,std_id,status,grp_id)
values (
'akash','ECE','1BM17EC005','true','BMSCE'
);

--retreive
select * from student_s where std_name = 'akash';

--update
update student_s 
set std_code = 'BMS'
where std_name = 'akash';
...
insert into groups_s (grp_name,grp_code,grp_id,status,clg_id)
...
insert into groups_s (grp_name,grp_code,grp_id,status,clg_id)
values (
'BMSCE','ECE','1BM17EC005','true','BMSCE'
);

--retreive
select * from groups_s where grp_name = 'BMSCE';

--update
update groups_s 
set grp_code = 'BMS'
where grp_name = 'BMSCE';

--delete
delete from groups_s
where grp_name = 'BMSCE';
...
insert into colleges_s (clg_name,clg_code,clg_id,status)
...
insert into colleges_s (clg_name,clg_code,clg_id,status)
values (
'BMSCE','BMSBAS','1BM17EC005','true'
);

--retreive
select * from colleges_s where clg_name = 'BMSCE';

--update
update colleges_s 
set clg_code = 'BMS'
where clg_name = 'BMSCE';

--delete
delete from colleges_s
where clg_name = 'BMSCE';